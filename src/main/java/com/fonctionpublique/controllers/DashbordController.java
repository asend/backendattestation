...
//    private final DashbordServicep dashbordService;
    ...
    @GetMapping("/demande/signature")
    public ResponseEntity<List<DemandeDTO>> getDemandeBySingature(@RequestParam String signature) {
        List<DemandeDTO> demandes = dashbordService.getDemandeApprouvedBySignature(signature);
